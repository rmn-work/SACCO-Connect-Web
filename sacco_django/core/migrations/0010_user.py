...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0009_partenaire_alter_pret_statut'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('member', 'Membre'), ('partner', 'Partenaire'), ('admin', 'Administrateur')], default='member', max_length=20)),
