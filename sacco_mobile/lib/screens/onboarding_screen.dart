...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  List<Map<String, String>> get _pages => [
    {
      "subtitle": "onboarding_sub_0".tr(),
      "description": "onboarding_desc_0".tr(),
    },
    {
              ...
              children: [
                    ...
                    children: [
                      if (_currentPage < pages.length - 1)
                        TextButton(
                          ...
                          child: Text(
                            "skip".tr(),
                            style: const TextStyle(color: Color(0xFF1A56A3), fontWeight: FontWeight.bold),
                          ),
                        ),
                    ],
                  ),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      _currentPage == pages.length - 1 ? "start".tr() : "next".tr(),
